...
<body>
    ...
    <?php 
         ...
         if(mysqli_num_rows($verify_query) !=0 ){
            ...
            mysqli_query($con,"INSERT INTO form_detail(FName,DOB, Email, Password, Gen, Branch, Clgname, Userid, Sesion, Project, Sem, Domain) VALUES('$name','$dob','$email','$password','$gen','$branch','$clgname','$userid','$session','$project','$sem','$domain')") or die("Erroe Occured");

            echo "<div class='message'>
                      <p>Registration successfully!</p>
                  </div> <br>";
            echo "<a href='loginphp.php'>
